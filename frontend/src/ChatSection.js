...
export const ActionButton = styled.button`
  ...
  &:hover:not(:disabled) { // Modificado para não aplicar hover quando desabilitado
...
export function ChatToolbar({ children, isStreamingMode, toggleStreamingMode, openPrescriptionModal, openSettingsModal }) { //
  // O conteúdo específico da toolbar (botões, etc.) agora será definido em App.js
  // e passado via 'children' para este componente Toolbar.
  return (
    <Toolbar> {/* */}
